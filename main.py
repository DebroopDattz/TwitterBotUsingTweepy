...
consumer_key = '1349356795077148672-lTCkEEO4JPJnQMpRzibZhDri6nujFm'
consumer_secret = '27YVtr5CJJzOifhWfQ3YOmCvSg1IdmeOJ5cyI3IMRGbeW'
access_token = 'bdc210S40L38tk8gTrVZpmOn2'
access_token_secret = 'sAjiDGK4kwZUO3xieq7mTeg4OJAwiqaqSYeNxn0x7BjkO7Q0RU'

auth = tweepy.OAuthHandler(consumer_key, consumer_secret)
auth.set_access_token(access_token, access_token_secret)
api = tweepy.API(auth)

user = api.get_blocked_idsme()
print(user.name)
print(user.location)
